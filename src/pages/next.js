...
class Next extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            allPage: ["profile", "spotify", "genius", "confirm"],
            curPage: "profile",
    ...
    componentDidMount() {
        ...
        if (window.location.href.includes("spotifyAuth?code=") || localStorage.getItem("spotifyAuth")) {
            ...
            this.setState({ spotifyAcc: "Connected", curPage: "genius" });
            fetch(`https://accounts.spotify.com/api/token`, {
                ...
                .then(result => {
                    ...
                    this.spotifyTokenInterval = setInterval(this.spotifyTokenRefresh, 3500000);
                });
        }
