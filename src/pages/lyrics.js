    ...
    renderHeader() {
        return (<>
            <svg className="player-divider">
                <path d={`M0,0 L${this.state.width},0 L${this.state.width},50 C${this.state.width},50 150,150 0,300`} />
            </svg>
            <svg className="header">
                <path id="curve" d={`M0,300 C0,300 150,150 ${this.state.width},40`} />
                <text x="50">
                    <textPath className="curveHeader style1" xlinkHref="#curve">
                    ...
                    <div className="vrtTL">
                        ...
                        <div>
                            ...
                            <Button shape="pill" color="fill" label="re-build queue"
                                onClick={this.rebuildQueue.bind(this)}
                            />
